...
export default function Wishes() {
    ...
    const options = [
        ...
        { value: 'MAYBE', label: 'ربما، سأؤكد لاحقًا' }
    ];
    // أمثلة على التهاني - يمكن استبدالها ببيانات حقيقية
    const [wishes, setWishes] = useState([
        {
            id: 1,
            name: "محمد",
            message: "أتمنى لكما حياة مليئة بالحب والضحك والسعادة! 🎉",
        ...
        },
        {
            id: 3,
            name: "عمر",
            message: "مبروك يومكم الخاص! بارك الله في زواجكم! 🤲",
    ...
    const handleSubmitWish = async (e) => {
        ...
        const newWishObj = {
            id: wishes.length + 1,
            name: "ضيف", // يمكن استبداله باسم المستخدم الحقيقي
            message: newWish,
            attend: "attending",
                ...
                >
                        ...
                        <div className="backdrop-blur-sm bg-white/80 p-6 rounded-2xl border border-rose-100/50 shadow-lg">
                            <div className='space-y-2'>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        placeholder="أرسل تهنئتك وأمنياتك للعروسين..."
                            ...
                            <div className="flex items-center justify-between mt-4">
                                <div className="flex items-center space-x-2 text-gray-500">
                                    ...
                                    <span className="text-sm">شاركنا تهنئتك</span>
                                </div>
                                <motion.button
                    ...
                    ${isSubmitting
                                ...
                                >
                                    ...
                                    <span>{isSubmitting ? 'جاري الإرسال...' : 'إرسال التهنئة'}</span>
                                </motion.button>
                            </div>
                        </div>
                    </form>
